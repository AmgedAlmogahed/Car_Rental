...
import com.example.accountrental.database.AccountsDao
 ...
 * so you can reuse it.
 */
@Database(entities = [Accounts::class,Cars::class,Renting::class,Customers::class,Services::class], version = 2, exportSchema = false)
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract val rentingDao: RentingDao
    /**
